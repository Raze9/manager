<template>
  <div style="padding: 10px">
    ...
    <div>
      <div style="margin: 10px 0"/>
      <el-input v-model="search"  style="width: 30%"  placeholder="请输入 " clearable />
    ...
    <el-table :data="tableData" border stripe style="width: 100%;padding-top: 5px">
      ...
      <el-table-column fixed="right" label="操作">
        <template #default="scope">
          ...
          <template #reference>
          <el-button size="small" type="danger" @click="handDelete(scope.row.id)">删除</el-button>
        </template>
          </el-popconfirm>
        </template>
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    handleEdit(row){
     ...
     handleSizeChange(pageSize){   //展示条数
